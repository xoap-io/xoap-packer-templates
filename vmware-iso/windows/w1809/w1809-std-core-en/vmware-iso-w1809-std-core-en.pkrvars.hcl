...
iso_url              = "../../../../iso/SW_DVD9_Win_Server_STD_CORE_1809.1_64Bit_English_DC_STD_MLF_X22-03530.ISO"
keep_input_artifact  = true
max_retries          = 0
memory               = 4096
network_adapter_type = ""
output_directory     = "./output/w1809-std-core-en"
ovftool_options      = []
pause_before         = "10s"
restart_command      = ""
restart_timeout      = "5m"
