Configuration Citrix_Windows_10_1709{
    ...
    Write-Verbose "Service DoSvc will be Disabled."
    Service "DoSvc"{
    Name        = "DoSvc"
    State       = "stopped"
    StartupType = "Disabled"
    ...
    ScheduledTask "ResolutionHost"
{
    ...
    Write-Verbose "Scheduled Task CleanupOfflineContent will be Disabled."
