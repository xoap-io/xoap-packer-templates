Configuration citrix-optimizer-windows-server-2022-2009 {
...
Import-DSCResource -ModuleName "ComputerManagementDsc"
    ...
    Node citrix-optimizer-windows-server-2022-2009
    {
        ...
        Write-Verbose "Service SEMgrSvc will be Disabled."
        Service "SEMgrSvc"{
        Name        = "SEMgrSvc"
        State       = "stopped"
        StartupType = "Disabled"
        ...
        Write-Verbose "Service shpamsvc will be Disabled."
        Service "shpamsvc"{
        Name        = "shpamsvc"
        State       = "stopped"
        StartupType = "Disabled"
        ...
        Write-Verbose "Scheduled Task CreateObjectTask will be Disabled."
        ...
        Write-Verbose "Scheduled Task IndexerAutomaticMaintenance will be Disabled."
        ...
        Write-Verbose "Scheduled Task MobilityManager will be Disabled."
        ...
        Write-Verbose "Scheduled Task TPM-Maintenance will be Disabled."
        ...
        Write-Verbose "Scheduled Task UPnPHostConfig will be Disabled."
        ...
        Write-Verbose "Scheduled Task Recovery-Check will be Disabled."
...
citrix-optimizer-windows-server-2022-2009
