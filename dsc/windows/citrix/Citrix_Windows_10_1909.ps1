Configuration Citrix_Windows_10_1909{
...
Registry "CrashDumpEnabled"
{
    ...
    Write-Verbose "Registry Key NtfsDisableLastAccessUpdate will be set to: 2147483650."
