Configuration citrix-optimizer-windows-11-2009 {
...
Import-DSCResource -ModuleName "ComputerManagementDsc"
    ...
    Node citrix-optimizer-windows-11-2009
    {
        ...
        Write-Verbose "Service PimIndexMaintenanceSvc will be Disabled."
        ...
        Write-Verbose "Service MapsBroker will be Disabled."
        Service "MapsBroker"{
        Name        = "MapsBroker"
        State       = "stopped"
        StartupType = "Disabled"
        ...
        Write-Verbose "Service BcastDVRUserService will be Disabled."
        ...
        Write-Verbose "Service lfsvc will be Disabled."
        Service "lfsvc"{
        Name        = "lfsvc"
        State       = "stopped"
        StartupType = "Disabled"
        ...
        Write-Verbose "Service MessagingService will be Disabled."
        ...
        Write-Verbose "Scheduled Task Cellular will be Disabled."
        ...
        Write-Verbose "Scheduled Task Diagnostics will be Disabled."
        ...
        Write-Verbose "Scheduled Task NotificationTask will be Disabled."
        ...
        Write-Verbose "Scheduled Task RecommendedTroubleshootingScanner will be Disabled."
        ...
        Write-Verbose "Scheduled Task ReconcileFeatures will be Disabled."
        ...
        Write-Verbose "Scheduled Task ReconcileLanguageResources will be Disabled."
        ...
        Write-Verbose "Scheduled Task RefreshCache will be Disabled."
        ...
        Write-Verbose "Scheduled Task ResPriStaticDbSync will be Disabled."
        ...
        Write-Verbose "Scheduled Task ScanForUpdates will be Disabled."
        ...
        Write-Verbose "Scheduled Task ScanForUpdatesAsUser will be Disabled."
        ...
        Write-Verbose "Scheduled Task SilentCleanup will be Disabled."
        ...
        Write-Verbose "Scheduled Task SmartRetry will be Disabled."
        ...
        Write-Verbose "Scheduled Task SpaceAgentTask will be Disabled."
        ...
        Write-Verbose "Scheduled Task SpaceManagerTask will be Disabled."
        ...
        Write-Verbose "Scheduled Task SpeechModelDownloadTask will be Disabled."
        ...
        Write-Verbose "Scheduled Task Sqm-Tasks will be Disabled."
        ...
        Write-Verbose "Scheduled Task StorageSense will be Disabled."
        ...
        Write-Verbose "Scheduled Task UninstallDeviceTask will be Disabled."
        ...
        Write-Verbose "Scheduled Task Usb-Notifications will be Disabled."
        ...
        Write-Verbose "Scheduled Task WIM-Hash-Management will be Disabled."
        ...
        Write-Verbose "Scheduled Task WsSwapAssessmentTask will be Disabled."
        ...
        Write-Verbose "Registry Key DeleteUserAppContainersOnLogoff will be set to: 1."
        ...
        Write-Verbose "Registry Key NtfsDisableLastAccessUpdate will be set to: 2147483651."
...
citrix-optimizer-windows-11-2009
