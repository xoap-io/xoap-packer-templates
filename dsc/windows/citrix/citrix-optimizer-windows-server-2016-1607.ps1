Configuration citrix-optimizer-windows-server-2016-1607.ps1 {
...
Import-DSCResource -ModuleName "ComputerManagementDsc"
    ...
    Node citrix-optimizer-windows-server-2016-1607
    {
        ...
        Write-Verbose "Scheduled Task SmartScreenSpecific will be Disabled."
        ...
        Write-Verbose "Scheduled Task XblGameSaveTaskLogon will be Disabled."
...
citrix-optimizer-windows-server-2016-1607
