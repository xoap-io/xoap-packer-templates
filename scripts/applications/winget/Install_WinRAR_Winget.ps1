<#
.SYNOPSIS
    Installs WinRAR using winget on Windows Server 2025

.DESCRIPTION
    This script installs WinRAR using winget.
...
try {
    Write-Log "Installing WinRAR via winget..."
    winget install --id WinRAR.WinRAR --silent --accept-package-agreements --accept-source-agreements -e
