<#
.SYNOPSIS
    Installs Google Chrome using winget on Windows Server 2025

.DESCRIPTION
    This script installs Google Chrome using winget.
...
try {
    Write-Log "Installing Google Chrome via winget..."
