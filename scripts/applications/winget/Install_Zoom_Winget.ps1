<#
.SYNOPSIS
    Installs Zoom using winget on Windows Server 2025

.DESCRIPTION
    This script installs Zoom using winget.
...
try {
    Write-Log "Installing Zoom via winget..."
    winget install --id Zoom.Zoom --silent --accept-package-agreements --accept-source-agreements -e
