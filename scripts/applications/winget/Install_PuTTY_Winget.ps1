<#
.SYNOPSIS
    Installs PuTTY using winget on Windows Server 2025

.DESCRIPTION
    This script installs PuTTY using winget.
...
try {
    Write-Log "Installing PuTTY via winget..."
    winget install --id PuTTY.PuTTY --silent --accept-package-agreements --accept-source-agreements -e
