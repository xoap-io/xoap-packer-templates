<#
.SYNOPSIS
    Installs Postman using winget on Windows Server 2025
...
try {
    Write-Log "Installing Postman via winget..."
    winget install --id Postman.Postman --silent --accept-package-agreements --accept-source-agreements -e
    Write-Log "Postman installed successfully."
} finally {
    try { Stop-Transcript | Out-Null } catch {}
}
