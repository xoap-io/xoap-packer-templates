<#
.SYNOPSIS
    Installs Python 3 using winget on Windows Server 2025

.DESCRIPTION
    This script installs Python 3 using winget.
...
try {
    ...
    winget install --id Python.Python.3 --silent --accept-package-agreements --accept-source-agreements -e
