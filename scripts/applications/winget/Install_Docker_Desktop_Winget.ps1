<#
.SYNOPSIS
    Installs Docker Desktop using winget on Windows Server 2025

.DESCRIPTION
    This script installs Docker Desktop using winget.
...
try {
    ...
    winget install --id Docker.DockerDesktop --silent --accept-package-agreements --accept-source-agreements -e
