<#
.SYNOPSIS
    Installs 7-Zip using winget on Windows Server 2025

.DESCRIPTION
    This script installs 7-Zip using winget.
...
try {
    ...
    winget install --id 7zip.7zip --silent --accept-package-agreements --accept-source-agreements -e
