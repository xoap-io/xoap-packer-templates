<#
.SYNOPSIS
    Installs Notepad++ using winget on Windows Server 2025

.DESCRIPTION
    This script installs Notepad++ using winget.
...
try {
    Write-Log "Installing Notepad++ via winget..."
    winget install --id Notepad++.Notepad++ --silent --accept-package-agreements --accept-source-agreements -e
